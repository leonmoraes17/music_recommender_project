...
# this is the data which has been reduced from 50k to 30k based on the unqiue track id which client has listened to
filtered_data_path = "D:/spotify_recommender/data/collab_filtered_data1.csv"

# save path
save_path = "D:/spotify_recommender/data/transformed_hybrid_data.npz"
